...
// checks if the ResponseClearDefault type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseClearDefault{}

// ResponseClearDefault struct for ResponseClearDefault
type ResponseClearDefault struct {
...
type _ResponseClearDefault ResponseClearDefault
...
func (o *ResponseClearDefault) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o ResponseClearDefault) MarshalJSON() ([]byte, error) {
...
func (o ResponseClearDefault) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseClearDefault) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseClearDefault := _ResponseClearDefault{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseClearDefault)

	if err != nil {
		return err
	}

	*o = ResponseClearDefault(varResponseClearDefault)

	return err
}

type NullableResponseClearDefault struct {
	value *ResponseClearDefault
	isSet bool
}

func (v NullableResponseClearDefault) Get() *ResponseClearDefault {
	return v.value
}

func (v *NullableResponseClearDefault) Set(val *ResponseClearDefault) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseClearDefault) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseClearDefault) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseClearDefault(val *ResponseClearDefault) *NullableResponseClearDefault {
	return &NullableResponseClearDefault{value: val, isSet: true}
}

func (v NullableResponseClearDefault) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseClearDefault) UnmarshalJSON(src []byte) error {
	v.isSet = true
